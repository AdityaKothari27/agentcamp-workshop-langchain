...
- MCP tools: LangChain documentation search and Redis operations

Guidelines:
- For weather, use get_weather
- For LangChain questions, use the docs search tool
- For cache/data-store tasks, use Redis MCP tools
...
async def get_mcp_tools():
    ...
    Expects Redis MCP server URL in REDIS_MCP_URL.
    """
